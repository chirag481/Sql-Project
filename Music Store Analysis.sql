...
SELECT DISTINCT email AS Email,first_name AS FirstName, last_name AS 
LastName, genre.name AS Name
FROM customer
...
top amount spent is shared, provide all customers who spent this amount. */TABLE
